...
description: Generated from skills/dispatch-repair.md (package reference copy)
---
...
# Archive old experiments (with dry-run support)
expflow dispatch archive 2025-06-01 --dry-run
expflow dispatch archive 2025-06-01
...
```
expflow_pde/
├── dispatch_db.py     — DispatchDB SQLite class (957 lines)
