...
class TestListExperiments:
    ...
    def test_list_experiments(self, mock_deps):
        ...
        from expflow_pde.dispatcher import dispatch_experiment, list_experiments
...
class TestGetExperimentStatus:
    ...
    def test_get_status_returns_dict(self, mock_deps):
        ...
        from expflow_pde.dispatcher import dispatch_experiment, get_experiment_status
...
class TestCancelExperiment:
    ...
    def test_cancel_experiment(self, mock_deps):
        ...
        from expflow_pde.dispatcher import cancel_experiment, dispatch_experiment
